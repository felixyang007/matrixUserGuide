...
这里是Matrix的Http协议Rest API文档使用教程。

## 查看文档

1. 点击页面右上角头像悬浮框的 [关于Matrix]
2. 点击REST API
3. 即可进入文档页面

## 在线调试HTTP接口
1. 搜索/login接口，进行登陆
2. 获取登陆后的返回值，这便是你的Token。（也可以直接在Matrix头像下拉框的创建Token直接生成）
3. 前往API页面的【文档管理】
4. 点击【全局参数】
...
### 通过REST API释放设备
::: tip
该功能需升级至Matrix v2.5.0，与 `通过REST API占用设备并获取远程调试信息` 接口配合使用。
:::
1. 参考REST API的文档发起对应HTTP请求
