...
::: tip
手机接入后没显示在设备中心？可前往 [设备接入指南](https://felixyang007.github.io/matrixUserGuide/deploy/android-deploy.html) 查看哦~
:::
...
A1: 可以查看 [设备接入文档](https://felixyang007.github.io/matrixUserGuide/deploy/android-deploy.html) ，依然无效可以查看Agent的日志进行排查。
