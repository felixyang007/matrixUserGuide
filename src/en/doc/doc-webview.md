...
The iOS web debugging webkit protocol receiver is under continuous maintenance, you can go to [here](https://felixyang007.github.io/matrixUserGuide/siwa/re-siwa.html) to learn more.
