...
Manage resource permissions corresponding to Matrix roles. The system has a built-in supermanagement role, which will skip all authentication checks. [Related information can be found in the deployment document](https://felixyang007.github.io/matrixUserGuide/deploy/back-end-deploy.html)
