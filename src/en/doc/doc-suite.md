...
:::
iOS uses [sib perfmon](https://felixyang007.github.io/matrixUserGuide/sib/sib-perf.html) for performance collection.

### android
::: tip
This feature is only available after v2.2.0
:::
Android uses [sas perfmon](https://felixyang007.github.io/matrixUserGuide/sas/re-sas.html) for performance collection.
