...
::: tip
After the mobile phone is connected, it is not displayed in the device center? You can go to [Device Access Guide](https://felixyang007.github.io/matrixUserGuide/en/deploy/android-deploy.html) to view~
:::
...
A1: You can check [Device Access Documentation](https://felixyang007.github.io/matrixUserGuide/en/deploy/android-deploy.html), if it still doesn’t work, you can check the Agent’s log for troubleshooting.
